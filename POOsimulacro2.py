# """
# Un taller de diseño de autos quiere estudiar un nuevo prototipo. Para eso, nos piden hacer un modelo concentrado en las características del motor. El prototipo de
#  motor tiene 5 cambios
#  (de primera a quinta), y soporta hasta 5000 rpm. La velocidad del auto se calcula así: (rpm / 100) * (0.5 + (cambio / 2)). Por ejemplo en tercera a 2000 rpm, 
# la velocidad es 20 * (0.5 + 1.5) = 40. También nos interesa controlar el consumo. Se parte de una base de 0.05 litros por kilómetro. A este valor se le aplican los 
# siguientes ajustes:
